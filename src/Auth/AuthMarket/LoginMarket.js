...
export default function LoginMarket({navigation }){
    ...
    return(
        ...
        >
            <Text style={styles.title}>Login supermercado</Text>
            <TextInput 
                style={styles.input}
            ...
            <Text style={styles.registration}>
                Ainda Não tem cadastro como supermercado Parceiro?
